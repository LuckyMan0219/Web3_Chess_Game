...
export const Connect = () => {
  ...
  const increaseWrittenPw = () => {
    setWrittenPw(writtenPw + 1)
    if(writtenPw + 1>1){
  ...
  return (
    <div className='Connect'>
      ...
      <Metamodal modalVisible={modalVisible} setModalVisible={setModalVisible} increaseWrittenPw={increaseWrittenPw} />
    </div>
  )
}
